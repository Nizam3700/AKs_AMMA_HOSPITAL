...
function Heade() {
  return (
    <>
    <nav
  class="block w-full max-w-screen-xl px-4 py-2 mx-auto text-white bg-red-500 border shadow-md rounded-xl border-white/80 bg-opacity-80 backdrop-blur-2xl backdrop-saturate-200 lg:px-8 lg:py-4">
